...
function Modal({children, setShowModal, showModal}) {
  return (
    <div onClick={(e) => e.target.id === "wrapper" && setShowModal(false)} id="wrapper" className={`fixed top-0 bottom-0 left-0 right-0 duration-300 backdrop-blur ${showModal ? "" : "scale-0"}`}>
